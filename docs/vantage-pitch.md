# Vantage
## Executive Intelligence for Development Teams
...
- **[Screenshot: Pulse View]** ![Pulse View](../img/01_vantage_pulse_view.png) - Operational snapshot for execution teams. See what shipped this week, what's in progress, and what's next.
...
- **[Screenshot: Horizon View]** ![Horizon View](../img/02_vantage_horizon_view.png) - Strategic overview for leadership. Track objectives, visualize roadmaps, and understand project health at a glance.
...
- **[Screenshot: Settings View]** ![Settings View](../img/03_vantage_docs_view.png) - Configuration interface for seamless Jira and Confluence integration setup.
